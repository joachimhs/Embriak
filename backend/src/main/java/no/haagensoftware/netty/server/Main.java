...
import no.haagensoftware.netty.webserver.plugin.PostSenseRouterPlugin;
...
public class Main {
	...
	public void run() throws Exception {
		...
		RiakEnv dbEnv = new RiakEnv();
		dbEnv.setup();
		
		List<NettyWebserverRouterPlugin> routerPlugins = new ArrayList<NettyWebserverRouterPlugin>();
		routerPlugins.add(new PostSenseRouterPlugin(new ApplicationServerInfo(), dbEnv));
